...
int16_t 
fat16_read_file(struct fat16_file_struct* fd, char* buffer, uint16_t buffer_len);

int16_t 
fat16_write_file(struct fat16_file_struct* fd, const char* buffer, uint16_t buffer_len);

char
fat16_seek_file(struct fat16_file_struct* fd, int32_t* offset, char whence);
