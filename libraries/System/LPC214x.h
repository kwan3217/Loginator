...
#define RTCSEC         (*(volatile unsigned long *)(RTC_BASE_ADDR + 0x20))
#define RTCMIN         (*(volatile unsigned long *)(RTC_BASE_ADDR + 0x24))
#define RTCHOUR        (*(volatile unsigned long *)(RTC_BASE_ADDR + 0x28))
#define RTCDOM         (*(volatile unsigned long *)(RTC_BASE_ADDR + 0x2C))
#define RTCDOW         (*(volatile unsigned long *)(RTC_BASE_ADDR + 0x30))
#define RTCDOY         (*(volatile unsigned long *)(RTC_BASE_ADDR + 0x34))
#define RTCMONTH       (*(volatile unsigned long *)(RTC_BASE_ADDR + 0x38))
#define RTCYEAR        (*(volatile unsigned long *)(RTC_BASE_ADDR + 0x3C))
