...
template<int port>
class HardwareSerial: public Print<HardwareSerial<port>> {
  private:
#ifndef NOINT
  ...
  public:
    ...
    using Print<HardwareSerial<port>>::write;
};

extern HardwareSerial<0> Serial;
extern HardwareSerial<1> Serial1;
