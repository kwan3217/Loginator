...
void step1Task(void* stuff) {
  ...
  pinState=1-pinState;
  taskManager.reschedule(5,0,step2Task,0);
}
...
void step2Task(void* stuff) {
  ...
  pinState=1-pinState;
  taskManager.reschedule(25,0,step3Task,0);
}
...
void step3Task(void* stuff) {
  ...
  pinState=1-pinState;
  taskManager.reschedule(200,0,step1Task,0);
}
...
void setup() {
  ...
  taskManager.schedule(200,0,step1Task,0);
}
